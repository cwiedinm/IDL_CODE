...
;   
;APRIL 20, 2014
;- editing this code to run default FINN verion to set up for Yo
; *********************************************************************************************

pro global_fire_TEXAS
...
;   READ IN EMISSION FACTOR FILE
     ...
     ;emisin = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_INPUTS\NEW_EFS_UPPER_11192013.csv' ; Created 11/19/2013
...
; LCT GenVegType  Ge  CO2 CO  CH4 NMOC  H2  NOXasNO SO2 PM25  TPM TPC OC  BC  NH3 NO  NO2 NMHC  PM10
;LCT  GenVegType      CO2 CO  CH4 NMOC  H2  NOXasNO SO2 PM25  TPM TPC OC  BC  NH3 NO  NO2 NMHC  PM10
...
; OUTPUT FILE
; ****************************************************************************
     outfile = 'E:\Data2\wildfire\TEXAS\NEW_PROJECT_2014\TEST_OLD_OUTPUTS\FINN_newemis_04212014.txt'
     openw, 6, outfile
     ...
     form = '(D20.10,",",D20.10,",",(8(I10,",")),2(D20.10,","),17(D25.10,","),F6.3,",",A25)'
 
    ; Print an output log file
    logfile = 'E:\Data2\wildfire\TEXAS\NEW_PROJECT_2014\TEST_OLD_OUTPUTS\LOG_FINN_newemis_04212014.txt'
       openw, 9, logfile
...
;infile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODISFRMS\Testin.csv'  ;RAN ON 06/25/2013
  infile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODISFRMS\FRMS2008_ALL2.csv'  ;RAN ON 06/25/2013
...
; THIS IS FROM THE NEW CODE with GENVEG = 7 (From JUNE 2013) (10/30/2013)
; 5) Forests (based on latitude)
;    if lct[j] eq 2 then genveg = 3 ; Tropical Forest
;    if lct[j] eq 4 then genveg = 4 ; Temperate Forest
;    if lct[j] eq 1 or lct[j] eq 3 then begin  ; Needleleaf forests
...
; 	Bmass now gets calculated as a function of tree cover, too.
    ...
    ;For Brazil from Elliott Campbell, 06/14/2010
      if (lon[j] le -47.323 and lon[j] ge -49.156) and (lat[j] le -20.356 and lat[j] ge -22.708) then bmass1= 1100. else bmass1 = 500. ; 11/01/2013
    endif

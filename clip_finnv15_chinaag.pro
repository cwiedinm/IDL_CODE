...
; 
; March 06, 2014
; - saved as clip_finnv15_chinaag 
; - set to run only ag output from China region
; 
;-------------------------------
;+
...
for j = 0,11 do begin ; 2013 ONLY when j = 11
print, 'J = ', j
  ...
  if j eq 0 then begin ; 2002
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2002_11212014.txt'
  endif
  if j eq 1 then begin ; 2003
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2003_06242014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2003_11212014.txt'
  endif
  if j eq 2 then begin ; 2004
    year = 2004
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2004_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2004_11212014.txt'
  endif
  if j eq 3 then begin ; 2005
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2005_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2005_11212014.txt'
  endif
  if j eq 4 then begin ; 2006
    year = 2006
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2006_06262014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2006_11212014.txt'
  endif
  if j eq 5 then begin ; 2007
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2007_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2007_11212014.txt'
  endif
  if j eq 6 then begin ; 2008
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2008_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2008_11212014.txt'
  endif
  if j eq 7 then begin ; 2009
    year = 2009
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2009_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2009_11212014.txt'
  endif
  if j eq 8 then begin ; 2010
    year = 2010
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2010_06262014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2010_11212014.txt'
  endif
  if j eq 9 then begin ; NEW 2011 (03/2012)
    year = 2011
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2011_11212014.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FINNv15_ChinaAG_2012_11212014.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\SPECIATED\MOZ4\GLOBAL_FINNv15_2013_MOZ4_7112014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\DEC2014\FINNv15_ChinaAG_03062015.txt'
  endif
   if j eq 12 then begin ; 2014
    year = 2014
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\NOV2014\GLOBAL_FINNv15a_2014thru0831_11252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\MAR_2015\chinaag\FFINNv15_ChinaAG2014Aug31_11262014.txt'
  endif
  
    
openw, 1, output1
printf, 1, 'day,latitude, longitude, bmass, area, CO2,CO,CH4,NOx,NMOC,NH3,SO2,PM2.5, PM10, OC, BC'
form = '(I6,15(",",D25.10))'
...
; Edtied 03/06/2015 for Western US
latmin = 23.0
latmax = 40.0
lonmin = 92.0
lonmax = 116.
daymin = 0 ; August 01
daymax = 365 ; August 31
...
; 03/06/2015 - include only genveg[i] = 9
      today = where(lati gt latmin and lati lt latmax and longi lt lonmax and longi gt lonmin and day eq i and genveg eq 9)
...
;  if (lati[i] lt latmax and lati[i] gt latmin and longi[i] gt lonmin and longi[i] lt lonmax and day[i] gt daymin and day[i] lt daymax and genveg[i] eq 9) then begin
    ; 'day,latitude, longitude, bmass, area, CO2,CO,CH4,NOx,NMOC,NH3,SO2,PM2.5, PM10, OC, BC'
;    printf, 1, format = form, day[i], lati[i], longi[i], bmass[i], area[i], co2[i], co[i],ch4[i],nox[i],voc[i],nh3[i],so2[i],pm25[i],pm10[i],oc[i],bc[i]
;  endif
;endfor

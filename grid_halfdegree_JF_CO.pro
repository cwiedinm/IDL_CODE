...
yearfile = '2012'
n_files = 1
txtfile1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\SPECIATED\MOZ4\GLOBAL_FINNv15_2012_MOZ4_7112014.txt'
...
for ispec=1,1 do begin ; ONLY DO CO (JULY 10, 2014)
  spec = specs[ispec]
  mw = molwts[ispec]
  case spec of
    'CO2': fire_data = co2
 ...
 ncfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\JEANFRANCOIS\FINNv15_global_'+yearfile+'_'+spec+'_'+resol+'.nc'
 print,ncfile
 ...
 ncdf_attput,ncid,/GLOBAL,'History','Created '+todaystr+' from FINNv1.5 MOZ4 files'

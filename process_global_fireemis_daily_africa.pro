...
pro process_global_fireemis_daily_africa
...
for j = 0,12 do begin ; j loop is over outputs for 2005-2011. 
  ...
  if j eq 0 then begin ; 2005
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_2005_AFRICA_05102011.txt'
endif
  if j eq 1 then begin ; 2006
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_2006_AFRICA_05102011.txt'
  endif
  if j eq 2 then begin ; JAN-APR 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_JAN-APR2007_AFRICA_05102011.txt'
  endif
  if j eq 3 then begin ; MAY-SEPT 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_MAY-SEPT2007_AFRICA_05102011.txt'
  endif
  if j eq 4 then begin ; OCT-DEC 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_OCT-DEC2007_AFRICA_05102011.txt'
  endif
  if j eq 5 then begin ; JAN-APR 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_JAN-APR2008_AFRICA_05102011.txt'
  endif
  if j eq 6 then begin ; MAY-SEPT 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_MAY-SEPT2008_AFRICA_05102011.txt'
  endif
  if j eq 7 then begin ; OCT-DEC 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_OCT-DEC2008_AFRICA_05102011.txt'
  endif
  if j eq 8 then begin ; JAN-NOV 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_JAN-NOV2009_AFRICA_05102011.txt'
  endif
  if j eq 9 then begin ; DEC 2009
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\GLOB_DEC2009_09092010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_DEC2009_AFRICA_05102011.txt'
  endif
  if j eq 10 then begin ; JAN-JUN29 2010
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2011\GLOB_JAN-JUN2010_04042011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_JAN-JUN29_2010_AFRICA_05102011.txt'
  endif
  if j eq 11 then begin ; JUN30-DEC 2010
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2011\GLOB_JUN-DEC2010_04042011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_JUN30-DEC2010_AFRICA_05102011.txt'   
  endif
  if j eq 12 then begin ; JAN-APR 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2011\GLOB_JAN-APR2011_05042011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\AFRICA\DAILY_FIREEMIS_GLOB_JAN-APR2011_AFRICA_05102011.txt'     
  endif
  
  
openw, 1, output1

printf, 1, 'Daily AUSTRAILIA Emissions from '+infile
...
; Lat: -40 - 0; Long: 5 - 55'
printf, 1, 'TOTALS for NAFRICA (Lat: 0-23; Long: -20 - 60) and SAFRICA (Lat: -40 - 0; Long: 5 - 55) (kg Species)
Printf, 1, 'JD,CO2_NA,CO_NA,NOX_NA,NO_NA,NO2_NA,NH3_NA,SO2_NA,VOC_NA,NMHC_NA,CH4_NA,PM25_NA,OC_NA,BC_NA,TPM_NA,PM10_NA,CO2_SA,CO_SA,NOX_SA,NO_SA,NO2_SA,NH3_SA,SO2_SA,VOC_SA,NMHC_SA,CH4_SA,PM25_SA,OC_SA,BC_SA,TPM_SA,PM10_SA'
for i = 0,count do begin
; NORTH AFRICA
  today = where(jday eq i AND (lati ge 0.0 and lati le 23. and longi gt -20.0 and longi lt 60.0))
...
; SOUTH AFRICA
today2 = where(jday eq i AND (lati ge -40. and lati le 0.0 and longi gt 5.0 and longi lt 55.))
  if today2[0] lt 0 then begin
  CO2in2 = 0.0
  COin2 = 0.0
  NOXin2 = 0.0
  NOin2 = 0.0
  ...
  if today2[0] ge 0 then begin
  CO2in2 = total(CO2[today2])
  COin2 = total(CO[today2])
  NOXin2 = total(NOX[today2])
  NOin2 = total(NO[today2])
  NO2in2 = total(NO2[today2])
  NH3in2 = total(NH3[today2])
  SO2in2 = total(SO2[today2])
  VOCin2 = total(VOC[today2])
  NMHCin2 = total(NMHC[today2])
  CH4in2 = total(CH4[today2])
  PM25in2 = total(PM25[today2])
  OCin2 = total(OC[today2])
  BCin2 = total(BC[today2])
  TPMin2 = total(TPM[today2])
  PM10in2 = total(PM10[today2])
  endif

  printf, 1, format = form, i,CO2in,COin,NOXin,NOin,NO2in,NH3in,SO2in,VOCin,NMHCin,CH4in,PM25in,OCin,BCin,TPMin,PM10in, $
                              CO2in2,COin2,NOXin2,NOin2,NO2in2,NH3in2,SO2in2,VOCin2,NMHCin2,CH4in2,PM25in2,OCin2,BCin2,TPMin2,PM10in2
  skip20:
endfor

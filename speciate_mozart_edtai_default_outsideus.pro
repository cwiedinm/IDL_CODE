...
; 
; May 17, 2013
; - Edited to clip N. America for 2008 for Ed Tai (Texas Project)
;
; September 05, 2013
; - edited to include the new SMARTFIRE files for Texas domain that includes SMARTFiRE fire type, fuel loading, and area
; 
; OCTOBER, 30, 2013
;changed the original code to read in new outputs 
;- this particular code, only includes areas outside the CONUS
;
;  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$

pro speciate_MOZART_edtai_DEFAULT_outsideUS
...
;infile = inpath + 'FINNv1_default_06252013_notUS.csv'
;infile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\OCT2008\FINNdefault_GLOBCOVER_APR-OCT2008_10282013.txt'
;outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\OCT2008\FINNdefault_GLOBCOVER_APR-OCT2008_MOZ4_10282013.txt'
; infile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK\FINNv1_TX_default_newemisOLD_10292013.txt'
; outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK\FINNv1_TX_default_newemisOLD_10292013_MOZ4.txt'


; CHECK NEW EMISSIONS SIMULATION
infile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\FINNv1_DEFAULT_10302013.txt'
outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\SPECIATED\FINNv1_DEFAULT_10302013_NOUS_MOZ4.txt'
checkfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\SPECIATED\LOG_FINNv1_DEFAULT_10302013_NOUS_MOZ4.txt'
...
printf, 5, 'DAY,TIME,GENVEG,LATI,LONGI,AREA,CO2,CO,H2,NO,NO2,SO2,NH3,CH4,NMOC,BIGALD,BIGALK,BIGENE,C10H16,C2H4,C2H5OH,C2H6,C3H6,C3H8,CH2O,CH3CHO,CH3COCH3,CH3COCHO,CH3COOH,CH3OH,CRESOL,GLYALD,HYAC,ISOP,MACR,MEK,MVK,HCN,CH3CN,TOLUENE,PM25,OC,BC,PM10,HCOOH,C2H2,state'  
form='(I6,",",I6,",",I6,",",43(D20.10,","),A20)' ; 10/30/2013 added STATE as last column
...
; longi,lat,day,TIME,lct,genLC,globreg,pcttree,pctherb,pctbare,area,bmass,CO2,CO,CH4,H2,NOx,NO,NO2,NH3,SO2,NMHC,NMOC,PM25,TPM,OC,BC,TPC,PM10,FACTOR,state,fuelload, type
...
if state[i] eq 'Newfoundland' or state[i] eq 'Nova Scotia' or state[i] eq 'Quebec' or state[i] eq 'Manitoba' or state[i] eq 'Alberta' or state[i] eq 'Saskatchewan' or state[i] eq 'Ontario' or state[i] eq 'British Columbia' or state[i] eq 'New Brunswick' or state[i] eq 'Baja California' or state[i] eq 'Chihuahua' or state[i] eq 'Coahuila' or state[i] eq 'Nuevo Leon' or state[i] eq 'Tamaulipas' or state[i] eq 'Sinaloa' or state[i] eq 'Durango' or state[i] eq 'Sonora' $
or state[i] eq 'Zacatecas' or state[i] eq 'San Luis Potosi' or state[i] eq 'Jalisco' or state[i] eq 'Aguascalientes' or state[i] eq 'Veracruz' or state[i] eq 'Nayarit' or state[i] eq 'Baja California Sur' then begin
  goto, keepgoing
endif else begin
  goto, skipfire
endelse
...
if genveg[i] eq 6 or genveg[i] eq 8 or genveg[i] eq 11 or genveg[i] eq 12 then STOP
...
if (genveg[i] eq 4  or genveg[i] eq 7) then convert2MOZ4 = tempfor
...
; PM10,        HCOOH,        C2H2'    
  PM10emis[i], HCOOHemis[i], C2H2emis[i], state[i]

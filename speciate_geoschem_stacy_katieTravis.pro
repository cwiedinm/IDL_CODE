...
; 
; July 08, 2014 (speciate_geoschem_stacy.pro)
...
; 
; August 26, 2014
; - Edited to speciate into more GEOS-chem species for Katie. Edited the input speciation table and the output format.
;$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$

pro speciate_geoschem_stacy_katieTravis
close, /all
...
;       convert = 'E:\Data2\wildfire\SPECIATION\Update_July2013\Geos_chem_speciation_table.csv' ; File created July 2013
      convert = 'E:\Data2\wildfire\SPECIATION\VOC2014\New_GEOSCHEM_Speciation_KatieTravis_Aug2014.csv'
...
; Takes fire emissions (kg/km2/day) and converts to mole species/km2/day
 ...
 ; The list of GEOSCHEM species in that file are (08/26/2014): 
;ACET
;ACTA
;ALD2
;ALK4
...
Infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06252014.txt'
outfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\AUGUST2014\KATIET\GLOBALv15_2013_GESOCHEM_08262014.txt'
checkfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\AUGUST2014\KATIET\LOG\LOG_GLOBALv15_2013_GESOCHEM_08262014.txt'
...
openw, 5, outfile
printf, 5, 'DAY,TIME,GENVEG,LATI,LONGI,AREA,CO2,CO,NO,NO2,SO2,NH3,CH4,ACET,ACTA,ALD2,ALK4,BENZ,C2H2,C2H4,C2H6,C3H8,CH2O,CH3BR,EOH,GLYC,GLYX,HAC,HCOOH,HNO2,ISOP,MACR,MEK,MEOH,MGLY,MONO,PRPE,TOLU,XYLE,OC,BC'
form='(I6,",",I6,",",I6,38(",",D20.10))'

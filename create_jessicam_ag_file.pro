...
outcrop = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\FEBRUARY2013\JESSICA\GLOB2012_CROP_02282013.txt'
...
printf, 1, 'DAY, LATITUDE, LONGITUDE, CO2, CO, PM25, Area, BIOMASS'
printf, 2, 'DAY, LATITUDE, LONGITUDE, CO2, CO, PM25, Area, BIOMASS'
printf, 3, 'DAY, LATITUDE, LONGITUDE, CO2, CO, PM25, Area, BIOMASS'
printf, 4, 'DAY, LATITUDE, LONGITUDE, CO2, CO, PM25, Area, BIOMASS'
printf, 5, 'DAY, LATITUDE, LONGITUDE, CO2, CO, PM25, Area, BIOMASS'
printf, 6, 'DAY, LATITUDE, LONGITUDE, CO2, CO, PM25, Area, BIOMASS'
...
;openw, 6, outcrop
;
if (genveg[i] eq 1) then printf, 1,format = form, day[i],lati[i],longi[i],co2[i], co[i],pm25[i],area[i],bmass[i] 
if (genveg[i] eq 2) then printf, 2,format = form, day[i],lati[i],longi[i],co2[i], co[i],pm25[i],area[i],bmass[i]
if (genveg[i] eq 3) then printf, 3,format = form, day[i],lati[i],longi[i],co2[i], co[i],pm25[i],area[i],bmass[i]
if (genveg[i] eq 4) then printf, 4,format = form, day[i],lati[i],longi[i],co2[i], co[i],pm25[i],area[i],bmass[i]
if (genveg[i] eq 5) then printf, 5,format = form, day[i],lati[i],longi[i],co2[i], co[i],pm25[i],area[i],bmass[i]
if (genveg[i] eq 9) then printf, 6,format = form, day[i],lati[i],longi[i],co2[i], co[i],pm25[i],area[i],bmass[i]

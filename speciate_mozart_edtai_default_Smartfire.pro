...
;
;NOVEMBER 02, 2013
;- saved as speciate_MOZART_edtai_DEFAULT_smartfire
;- included fire type and fuel load in output
;
;  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$

pro speciate_MOZART_edtai_DEFAULT_smartfire
...
infile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\FINNv1_SMARTFIRE_10302013.txt'
outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\SPECIATED\FINNv1_SMARTFIRE_10302013_MOZ4_11032013.txt'
checkfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\SPECIATED\LOG_FINNv1_SMARTFIRE_10302013_MOZ4_11032013.txt'
...
printf, 5, 'FIRETYPE,FUELLOAD,DAY,TIME,GENVEG,LATI,LONGI,AREA,CO2,CO,H2,NO,NO2,SO2,NH3,CH4,NMOC,BIGALD,BIGALK,BIGENE,C10H16,C2H4,C2H5OH,C2H6,C3H6,C3H8,CH2O,CH3CHO,CH3COCH3,CH3COCHO,CH3COOH,CH3OH,CRESOL,GLYALD,HYAC,ISOP,MACR,MEK,MVK,HCN,CH3CN,TOLUENE,PM25,OC,BC,PM10,HCOOH,C2H2,state'  
form='(A15,",",F25.10,",",I6,",",I6,",",I6,",",43(D20.10,","),A20)' ; 10/30/2013 added STATE as last column
...
printf, 5, format = form,type[i], load[i], day[i],time[i],genveg[i],lati[i],longi[i],area[i],CO2emis[i],COemis[i],H2emis[i], NOemis[i],NO2emis[i], SO2emis[i],NH3emis[i],CH4emis[i], VOCemis[i], $

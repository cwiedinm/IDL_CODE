...
pro process_regional_totals_JM
t0 = systime(1) ;Procedure start time in seconds
close, /all

openw, 1, 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OCTOBER2012\AG_PROCESS\Regional_AG_totals_10042012.txt' 
Printf, 1, 'FILE,year,REGION,CO2,CO,CH4,NMOC,NMHC,NOX,NO,NO2,NH3,SO2,PM25,TPM,OC,BC,AREA,BIOMASS'
...
printf, 1, format = form,j+1,year,reg,TOTCO2,TOTCO,TOTCH4,TOTNMOC,TOTNMHC,TOTNOX,TOTNO,TOTNO2,TOTNH3,TOTSO2,TOTPM25,TOTTPM,TOTOC,TOTBC,TOTAREA,TOTBMASS
...
reg = 'NH'
  today = where(lati gt 0. and genveg eq 9)
  if today[0] lt 0 then begin
    goto, skip22
   endif 
      TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'SH'
  today = where(lati lt 0. and genveg eq 9)
 if today[0] lt 0 then begin
     goto, skip23
  endif  
      TOTAREA = total(area[today])/1000000. ; km2
...
; Southern Hemisphere South America 
 reg = 'SHSA'
  today = where(lati gt -60. and lati lt 0. and longi gt -90. and longi lt -30. and genveg eq 9)
 if today[0] lt 0 then begin
     goto, skip25
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'SHAF'
  today = where(lati gt -40. and lati lt 0. and longi gt 5. and longi lt 55. and genveg eq 9)
 if today[0] lt 0 then begin
     goto, skip26
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'NHAF'
  today = where(lati ge 0. and lati lt 23. and longi gt -20. and longi lt 60. and genveg eq 9) 
  if today[0] lt 0 then begin
     goto, skip27
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'NAFME'
  today = where(lati gt 23. and lati lt 35. and longi gt -20. and longi lt 60. and genveg eq 9) 
  if today[0] lt 0 then begin
     goto, skip28
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
; EUROPE   
reg = 'EURO'
  today = where(lati gt 35. and lati lt 75. and longi gt -12. and longi lt 30. and genveg eq 9)
  if today[0] lt 0 then begin
     goto, skip29
  endif  
      TOTAREA = total(area[today])/1000000. ; km2
...
; AUSTRALIA 
reg = 'AUSTR'
  today = where(lati gt -50. and lati lt -10. and longi gt 110. and longi lt 180. and genveg eq 9) 
   if today[0] lt 0 then begin
     goto, skip30
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
; Equatorial ASIA
reg = 'EQAS'
  today = where(lati gt -10. and lati lt 5. and longi gt 90. and longi lt 165. and genveg eq 9) 
   if today[0] lt 0 then begin
     goto, skip31
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'SEAS'
  today = where(lati gt 5. and lati lt 35. and longi gt 60. and longi lt 145. and genveg eq 9)
   if today[0] lt 0 then begin
     goto, skip32
  endif  
      TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'CENAS'
  today = where(lati gt 35. and lati lt 50. and longi gt 30. and longi lt 155. and genveg eq 9)  
   if today[0] lt 0 then begin
     goto, skip33
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'BORAS'
  today = where(lati gt 50. and lati lt 80. and longi gt 30. and longi lt 180. and genveg eq 9)
     if today[0] lt 0 then begin
     goto, skip34
  endif  
      TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'BORNA'
  today = where(lati gt 49. and lati lt 79. and longi gt -169. and longi lt -44. and genveg eq 9)
     if today[0] lt 0 then begin
     goto, skip35
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'TEMNA'
  today = where(lati gt 27. and lati lt 49. and longi gt -130. and longi lt -60. and genveg eq 9)
     if today[0] lt 0 then begin
     goto, skip36
  endif  
     TOTAREA = total(area[today])/1000000. ; km2
...
reg = 'CENA'
     today = where(lati gt 12. and lati lt 27. and longi gt -120. and longi lt -60. and genveg eq 9)
     if today[0] lt 0 then begin
     goto, skip37
  endif  
     TOTAREA = total(area[today])/1000000. ; km2

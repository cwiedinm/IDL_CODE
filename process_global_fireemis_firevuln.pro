...
pro process_global_fireemis_firevuln
t0 = systime(1) ;Procedure start time in seconds
close, /all

for j = 0,12 do begin ; only do 2005-2011
  close, /all

  if j eq 0 then begin ; 2005
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\JUNE2011\GLOB_2005_06212011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_2005_08292012.txt'
  endif
  if j eq 1 then begin ; 2006
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2010\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_2006_08292012.txt'
  endif
  if j eq 2 then begin ; JAN-APR 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_JAN-APR2007_08292012.txt'
  endif
  if j eq 3 then begin ; MAY-SEPT 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_MAY-SEPT2007_08292012.txt'
  endif
  if j eq 4 then begin ; OCT-DEC 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_OCT-DEC2007_08292012.txt'
  endif
  if j eq 5 then begin ; JAN-APR 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_JAN-APR2008_08292012.txt'
  endif
  if j eq 6 then begin ; MAY-SEPT 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_MAY-SEPT2008_08292012.txt'
  endif
  if j eq 7 then begin ; OCT-DEC 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_OCT-DEC2008_08292012.txt'
  endif
  if j eq 8 then begin ; JAN-NOV 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_JAN-NOV2009_08292012.txt'
  endif
  if j eq 9 then begin ; DEC 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_DEC2009_08292012.txt'
  endif
  if j eq 10 then begin ; JAN-JUN29 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_JAN-JUN2010_08292012.txt'
  endif
  if j eq 11 then begin ; JUN30-DEC 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_JUN-DEC2010_08292012.txt'
  endif
  if j eq 12 then begin ; NEW 2011 (03/2012)
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2012\GLOBAL_2011_03142012.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_2011_08292012.txt'
  endif
if j eq 13 then begin ; 2002
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2002_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_2002_08292012.txt'
  endif
  if j eq 14 then begin ; 2003
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2003_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_2003_08292012.txt'
  endif
  if j eq 15 then begin ; 2004
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2004_05122011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2012\FIREVULN\DAILY_FIREEMIS_FIREVULN_2004_08292012.txt'
  endif
    
openw, 1, output1

;printf, 1, 'Daily Colorado Emissions from file: '+infile
printf, 1, 'latitude, longitude, day, PM2.5'
form = '(D25.10,",",D25.10,",",I10,",",D25.10)'
...
;Much of northern Hemisphere
; LAT: 0-90
; LONG: -50 - -180 or 80 to 180
for i = 0,nfires-1 do begin
  today = where(lati[i] ge 0. and lati[i] le 90. and longi[i] ge -180.0 and longi[i] le -50.0)
  today2 = where(lati[i] ge 0. and lati[i] le 90. and longi[i] ge 80.0 and longi[i] le 180.0)
  if (today[0] lt 0 AND today2[0] lt 0) then goto, skipfire
  if today[0] ge 0 then begin
    printf, 1, lati[i], longi[i], day[i], PM25[i]
  endif

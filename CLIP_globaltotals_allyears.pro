...
pro CLIP_globaltotals_allyears
t0 = systime(1) ;Procedure start time in seconds
close, /all

output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\NOVEMBER2012\SOAS\SEUS_totals.txt'
openw, 1, output1
printf, 1, 'year, fires, area, CO2, CO, SO2, NOX, NO, NO2, PM25, PM10, BC, OC, NMOC, NH3'
form = '(I6,",",I20,13(",",D25.10))'
...
for i = 0,nfires-1 do begin
  ...
  if (lati[i] lt latmin or lati[i] gt latmax or longi[i] gt lonmax or longi[i] lt lonmin) then goto, skip1 
  count2 = 1+count2
...
; ' 'year, fires, area, CO2, CO, SO2, NOX, NO, NO2, PM25, PM10, BC, OC, NMOC, NH3
 printf, 1, format = form, year, nfires, areatot, CO2tot, COtot, SO2tot, NOXtot, NOtot, NO2tot, PM25tot, PM10tot, BCtot, OCtot, voctot, NH3tot

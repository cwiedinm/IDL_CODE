...
;   
; APRIL 15, 2013
; - Edited to take in SMARTFILE input file
; 
; JUNE 26, 2013
; - edited for Texas
; 
; SEPTEMBER 13, 2013
; - Edited for Texas file.. (earlier in Sept. included Fire type and fuel load in output)
; - Not chekcing type, and removed the Overlaps in Tropics)
; 
; *********************************************************************************************

pro global_fire_SMARTFIRE_Texas
...
close, /all
 ...
 confmin = 20 ; minimum confidence level 
...
; ****************************************************************************
      ...
      outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\TEST_FINNv1_SMARTFIRE_11042013.txt'
     openw, 6, outfile
...
;     form = '(A20,",",A6,",",D20.10,",",D20.10,",",(8(I10,",")),3(D20.10,","),17(D25.10,","),F6.3)'
    ...
    logfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\CHECK10302013\LOG_TEST_FINNv1_SMARTFIRE_11042013.txt'
       openw, 9, logfile
...
printf,6,format = form, lon[j],lat[j],jd[j],1200,lct[j],genveg,globreg[j],tree[j],herb[j], $
;      pctbare,area,bmass,CO2,CO,CH4,H2,NOx,NO,NO2,NH3,SO2,NMHC,NMOC,PM25,TPM,OC,BC,TPC,PM10,FACTOR,        state';;
       bare[j],area,bmass,CO2,CO,CH4,H2,NOX,NO,NO2,NH3,SO2,NMHC,NMOC,PM25,TPM,OC,BC,TPC,PM10,Factortrop[j], state[j], fuelload, type[j]

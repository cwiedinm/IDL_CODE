...
pro CLIP_global_Monthly_SouthAmerica_deeter
t0 = systime(1) ;Procedure start time in seconds
close, /all

for j = 0,10 do begin ; do 2008 only 
  close, /all
...
for i = daymin,daymax do begin
    ...
    today = where(lati ge latmin and lati lt latmax and longi gt lonmin and longi lt lonmax and day eq i)
    COtot= total(CO[today])/1.e6

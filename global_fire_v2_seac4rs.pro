...
; 
; APRIL 20, 2015
; - renamed global_fire_v2_seac4rs.pro to run the 2013 file
; - look for 04/20/2015 in the code for changes
; ****************************************************************************************************************
;+
...
pro global_fire_v2_seac4rs, scen=scen, infile=infile, simid=simid ; 04/20/2015
  ...
  if not keyword_set(simid) then simid='mod2013_LRG'
...
todaydate = '_04212015' ; this is for naming the output file 04/20/2015
...
; ****************************************************************************
; yk_undo:  file/path
    outfile = 'E:\Data2\wildfire\TEXAS\NEW_PROJECT_2014\DOWNLOADS_APRIL2015\gis_tool\gis_tool\code\TEST04152015\TESTOUTPUT\FINNv2_'+ scename+'_'+ simid + '_'+ todaydate+'.txt' ;04/20/2015
...
; yk_undo:  file/path
    logfile = 'E:\Data2\wildfire\TEXAS\NEW_PROJECT_2014\DOWNLOADS_APRIL2015\gis_tool\gis_tool\code\TEST04152015\TESTOUTPUT\LOG_FINNv2_'+ scename+'_'+ simid + '_'+ todaydate+'.txt'
...
;DATE POLYID  FIREID  FIRELAT FIRELON Region  AREA  TREE  HERB  BARE  LCT ESA GLC FCCS FCCSTCEQ TCEQ  TCEQCDL pct_LCT,pct_ESA,pct_GLC,pct_FCCS,pct_FCCSTCEQ,pct_TCEQ,pct_TCEQCDL
...
; Identify Tropics: 
; Edited 04/20/2015 - shouldn't be included in N. American run
 tropics = where(lat1 gt -1 and lat1 lt 1) ; CW changed from 30 degrees to 23.5 degrees (03/11/2015)
...
if scen eq 6 then begin
  ...
  if where(tceqcdl[j] eq [102,103,104,105,106,161,162,163,164, 101,156, 92]) ne -1  then begin
    case 1 of
...
;###################################################################################################
;###################################################################################################
; SCENARIO #7 = ESA ONLY (Added 03/11/2015)
;###################################################################################################
;###################################################################################################

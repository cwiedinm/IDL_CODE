...
pro process_global_fireemis_daily_ALL_CALIFORNIA
t0 = systime(1) ;Procedure start time in seconds
close, /all

for j = 2,9 do begin ; only 2007-2009
  close, /all

  if j eq 0 then begin ; 2005
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\JUNE2011\GLOB_2005_06212011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_2005_05042012.txt'
  endif
  if j eq 1 then begin ; 2006
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2010\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_2006_05042012.txt'
  endif
  if j eq 2 then begin ; JAN-APR 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_JAN-APR2007_05042012.txt'
  endif
  if j eq 3 then begin ; MAY-SEPT 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_MAY-SEPT2007_05042012.txt'
  endif
  if j eq 4 then begin ; OCT-DEC 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_OCT-DEC2007_05042012.txt'
  endif
  if j eq 5 then begin ; JAN-APR 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_JAN-APR2008_05042012.txt'
  endif
  if j eq 6 then begin ; MAY-SEPT 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_MAY-SEPT2008_05042012.txt'
  endif
  if j eq 7 then begin ; OCT-DEC 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_OCT-DEC2008_05042012.txt'
  endif
  if j eq 8 then begin ; JAN-NOV 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_JAN-NOV2009_05042012.txt'
  endif
  if j eq 9 then begin ; DEC 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_DEC2009_05042012.txt'
  endif
  if j eq 10 then begin ; JAN-JUN29 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_JAN-JUN2010_05042012.txt'
  endif
  if j eq 11 then begin ; JUN30-DEC 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_JUN-DEC2010_05042012.txt'
  endif
  if j eq 12 then begin ; NEW 2011 (03/2012)
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2012\GLOBAL_2011_03142012.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_2011_05042012.txt'
  endif
if j eq 13 then begin ; 2002
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2002_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_2002_05042012.txt'
  endif
  if j eq 14 then begin ; 2003
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2003_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_2003_05042012.txt'
  endif
  if j eq 15 then begin ; 2004
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2004_05122011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2012\RACHEL_HEALTH\DAILY_FIREEMIS_CA_PM25_CO_2004_05042012.txt'
  endif
    
openw, 1, output1

printf, 1, 'Daily California Emissions from file: '+infile
printf, 1, 'day,lat, long, PM2.5, CO'
form = '(I10,4(",",D25.10))'
...
; 
if lati[i] lt 30. or lati[i] gt 43. or longi[i] lt -125.0 or longi[i] gt -113.0 then goto, skip20
  printf, 1, format = form, day[i],lati[i], longi[i],PM25[i],co[i]
  skip20:
endfor

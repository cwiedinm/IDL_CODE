...
for j = 9,12 do begin ; do 2011-2014
print, 'J = ', j
 ...
 if j eq 9 then begin ; NEW 2011
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2011_TOMODA_04222015.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2012_TOMODA_04222015.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2013_TOMODA_04222015.txt'
  endif
    ...
    year = 2014
       ...
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2014_TOMODA_04222015.xt'
  endif
  
    
openw, 1, output1
printf, 1, 'day,latitude, longitude,CO,PM2.5,PM10,TPM'
form = '(I6,6(",",D25.10))'
...
if year eq 2012 then daymax = 366


; USE THIS CODE TO PRINT OUT ALL FIRES IN THE AREA/TIME SPECIFIED
for i = 0,numfires-1 do begin
  if (lati[i] lt latmax and lati[i] gt latmin and longi[i] gt lonmin and longi[i] lt lonmax and day[i] ge daymin and day[i] le daymax) then begin
    ; 'day,latitude,longitude,CO,PM2.5,PM10,TPM'
    printf, 1, format = form, day[i], lati[i], longi[i], co[i],pm25[i],pm10[i], tpm[i]
  endif
endfor

...
pro process_global_fireemis_usonly_finnv15

t0 = systime(1) ;Procedure start time in seconds
close, /all

Print, 'annual emissions, kg/year) 
print, 'YEAR : TOTAL NMOC : TOTAL NMHC"
...
allvoc = where (lati gt latmin and lati lt latmax and longi gt lonmin and longi lt lonmax)
print, year,': ', total(nmoc(allvoc)),' : ', total(nmhc(allvoc))

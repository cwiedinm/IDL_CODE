...
;  OCTOBER 28, 2012
;   - Edited to output daily, Global CH4 emissions
;  
;  
;  FEBRUARY 27, 2016
;  - Edited to do 2003 - 2014 with FINNv1.5 emissions
;  - For Maurielle 
;  
;-------------------------------
;+
...
pro process_dailly_global_fireemis_global_CH4
...
for j = 1,12 do begin 
  ...
  if j eq 0 then begin ; 2002
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2002_02272016.txt'
  endif
  if j eq 1 then begin ; 2003
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2003_02272016.txt'
  endif
  if j eq 2 then begin ; 2004
    year = 2004
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2004_02272016.txt'
  endif
  if j eq 3 then begin ; 2005
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2005_02272016.txt'
  endif
  if j eq 4 then begin ; 2006
    year = 2006
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2006_02272016.txt'
  endif
  if j eq 5 then begin ; 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2007_02272016.txt'
  endif
  if j eq 6 then begin ; 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2008_02272016.txt'
  endif
  if j eq 7 then begin ; 2009
    year = 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2009_02272016.txt'
  endif
  if j eq 8 then begin ; 2010
    year = 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2010_02272016.txt'
  endif
  if j eq 9 then begin ; 
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2011_02272016.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2012_02272016.txt'
  endif  
  if j eq 11 then begin ; 2013
    ...
    infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2013_02272016.txt'
  endif
  if j eq 12 then begin ; 2014
    year = 2014
    infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\NOV_2015\FINNv1.5_2014_12012015.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\FEB2016\CH4_MARIELLE\Daily_Global_CH4_2014_02272016.txt'
  endif
...
;  if (lati[i] lt latmin or lati[i] gt latmax or longi[i] lt longmin or longi[i] gt longmax) then goto, skip20
  printf, 1, format = form, day[i], lati[i],longi[i], ch4[i]
  skip20:
endfor

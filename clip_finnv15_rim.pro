...
for j = 11,11 do begin ; 2013 ONLY when j = 11
print, 'J = ', j
  ...
  if j eq 5 then begin ; 2007
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2007_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\NOV2014\INDO\FINNv15_INDO_2007_11212014.txt'
  endif
  if j eq 6 then begin ; 2008
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2008_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\NOV2014\INDO\FINNv15_INDO_2008_11212014.txt'
  endif
   ...
   if j eq 11 then begin ; 2013
    year = 2013
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\SPECIATED\MOZ4\GLOBAL_FINNv15_2013_MOZ4_7112014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\DEC2014\FINNv15a_WESTUS_AUG2013_12112014.txt'
  endif
...
; FOR MOZ4 File (Changed 12/11/2014): 
...
for k=0L,nfires-1 do begin
  ...
  oc[k] = data1[41]
  bc[k] = data1[42]
  nox[k] = data1[9] ; REALLY NO (12/11/2014)
  nh3[k] = data1[12]
  so2[k] = data1[11]
  pm25[k] = data1[40]
;  tpm[k] = data1[24]
...
lonmin = -125.
lonmax = -100.
daymin = 213 ; August 01
daymax = 243 ; August 31

...
; JANUARY 06, 2011
;   - Cleaned up this version of code for Sean R. 
; ; *********************************************************************************************
...
; ****************************************************************************
     ...
     printf, 6, 'longi,lat,day,TIME,lct,genLC,globreg,pct_tree,pct_herb,pct_bare,area,bmass,CO2,CO,CH4,H2,NOx,NO,NO2,NH3,SO2,NMHC,NMOC,PM25,TPM,OC,BC,TPC,PM10,FACTOR'
     form = '(D20.10,",",D20.10,",",(8(I10,",")),2(D20.10,","),17(D25.10,","),F6.3)'

    ; Print an output log file
    logfile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OCTOBER2010\LOG\LOG_GLOB_2006_GLOBCOVER_10222010.txt'
       openw, 9, logfile
...
; ****************************************************************************
 ...
 infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2006\GLOBAL_2006_GLOBCOVER_INPUT.txt' ; ran 10/11/2010
...
;**************************************************************************************************************
; NOTE: NEED TO EDIT THESE FIELDS BEING READ IN TO MATCH THE INPUT FILE!!!
;       THat's what all of the comments above are...
; *************************************************************************************************************
        lat1 = map.field01
        lon1 = map.field02
        spix1 = map.field03
...
; ****************************************************************************
; SENSITIVITY STUDY: USING GLOBCOVEER LAND DATA INSTEAD OF MODIS LCT 
...
; ********************************************************************************************
; NOTE: Need to edit this section to match the format of the date read in in the input file        
...
;
; REMOVAL (1)
; REMOVAL OF OVERLAPPING FIRES (02.23.2009)
...
if genveg eq 3 then TOTTROP = TOTTROP+bmassburn
if genveg eq 4 then TOTTEMP = TOTTEMP+bmassburn
if genveg eq 5 then TOTBOR = TOTBOR+bmassburn
if genveg eq 2 then TOTSHRUB = TOTSHRUB+bmassburn
if genveg eq 9 then TOTCROP = TOTCROP+bmassburn
if genveg eq 1 then TOTGRAS = TOTGRAS+bmassburn

 ...
 ; December 29, 2008: Ran for 2006 for Mary's simulations
 ; ******************************************************************************************************************

 pro Fire_Emis_v4_maryb
...
; DECLARE INPUT FILE NAME
    ; infile = 'D:\Data2\wildfire\AGU2008\INPUT_FILES\Fire_input_file_2002.txt'
    ; infile = 'D:\Data2\wildfire\AGU2008\MODEL_OUTPUT\CHECK\2006185_modelinputs_CAonly.csv'
    ; infile = 'C:\WORK\FIRE\Fire_EMIS_122008\INPUT_FILES\Fire_input_file_2006.txt'
    infile = 'D:\Data2\wildfire\AGU2008\INPUT_FILES\Fire_input_file_2006.txt'
; ******************************************************************
; **************************************************************************************
;                  OUTPUT FILES
; ******************************************************************
; OUTPUT file pathway
    ...
    path2 = 'D:\Data2\wildfire\MaryB\US_12kmdomain\NEW_FIRE_FILES_12302008\'

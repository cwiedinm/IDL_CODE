...
pro process_global_fireemis_daily_SARAT
...
for j = 0,12 do begin ; j loop is over outputs for 2005-2011. 
  ...
  if j eq 0 then begin ; 2005
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_2005_SARAT_05102011.txt'
endif
  if j eq 1 then begin ; 2006
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_2006_SARAT_05102011.txt'
  endif
  if j eq 2 then begin ; JAN-APR 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_JAN-APR2007_SARAT_05102011.txt'
  endif
  if j eq 3 then begin ; MAY-SEPT 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_MAY-SEPT2007_SARAT_05102011.txt'
  endif
  if j eq 4 then begin ; OCT-DEC 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_OCT-DEC2007_SARAT_05102011.txt'
  endif
  if j eq 5 then begin ; JAN-APR 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_JAN-APR2008_SARAT_05102011.txt'
  endif
  if j eq 6 then begin ; MAY-SEPT 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_MAY-SEPT2008_SARAT_05102011.txt'
  endif
  if j eq 7 then begin ; OCT-DEC 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_OCT-DEC2008_SARAT_05102011.txt'
  endif
  if j eq 8 then begin ; JAN-NOV 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_JAN-NOV2009_SARAT_05102011.txt'
  endif
  if j eq 9 then begin ; DEC 2009
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\GLOB_DEC2009_09092010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_DEC2009_SARAT_05102011.txt'
  endif
  if j eq 10 then begin ; JAN-JUN29 2010
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2011\GLOB_JAN-JUN2010_04042011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_JAN-JUN29_2010_SARAT_05102011.txt'
  endif
  if j eq 11 then begin ; JUN30-DEC 2010
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2011\GLOB_JUN-DEC2010_04042011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_JUN30-DEC2010_SARAT_05102011.txt'   
  endif
  if j eq 12 then begin ; JAN-APR 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MAY2011\GLOB_JAN-APR2011_05042011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2011\PROCESS\SARAT\DAILY_FIREEMIS_GLOB_JAN-APR2011_SARAT_05102011.txt'     
  endif
...
; AUSTRALIA DAILY TOTALS
; 145.5 to 153.5 E longitude and 19.5 to 28.5 S latitude
printf, 1, 'AUST TOTALS (kg Species); 145.5 to 153.5 E longitude and 19.5 to 28.5 S latitude'
Printf, 1, 'JD,CO2,CO,NOX,NO,NO2,NH3,SO2,VOC,NMHC,CH4,PM25,OC,BC,TPM,PM10'
for i = 0,count do begin
  today = where(jday eq i AND (lati ge -28.5 and lati le -19.5 and longi gt 145.5 and longi lt 153.5))

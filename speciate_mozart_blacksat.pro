...
; 
; FEBRUARY 10_2012
; - Edited to only output what is needed for Black Saturday Study
;  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$

pro speciate_MOZART_BlackSat
...
infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\FEBRUARY2012\SEAUS_JAN-MAR2009_NEWLCT.txt' 
outfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\FEBRUARY2012\PROCESS\BLACKSAT\AUS_FEB-MAR2009_BLACKSAT_MOZ4_NEWLCT_02152012.txt'

checkfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\FEBRUARY2012\PROCESS\BLACKSAT\LOG_AUS_FEB-MAR2009_BLACKSAT_MOZ4_NEWLCT_02152012.txt'
; Edited the output file on 02/23/2009
; edited 11/18/2009; added NO and NO2
openw, 5, outfile

; NEW WAY (March 10, 2011)
printf, 5, 'DAY,TIME,GENVEG,LCT,LATI,LONGI,AREA,BMASS,CO2,CO,NOX,NO,NO2,SO2,NH3,CH4,NMOC,C2H2,C2H4,C2H6,C3H6,CH2O,CH3CHO,CH3OH,HCN,CH3CN,HCOOH,TOLUENE,TPM,OC,BC' 
form='(I6,",",I6,",",I6,",",I6,",",28(D20.10,","))'
...
; Edited these fields on NOV. 18, 2009
    ...
    genveg = fire.field06
	  CO2 = fire.field13
		...
		bmass = fire.field12 ; this should be 
    tpm = fire.field25
...
; CLIP OUT ONLY AUSTRALIA GRID FOR CLARE
; from clare (Feb 2012): 34S, 135E to 44S, 151E 
;  FOR BLACK SAT FIRES
latmin = -44.
latmax = -34.
longmin = 135.
...
; 
; NEW FORMAT
; printf, 5, 'DAY,TIME,GENVEG,LCT,LATI,LONGI,AREA,BMASS,CO2,CO,NOX,NO,NO2,SO2,NH3,CH4,NMOC,C2H2,C2H4,C2H6,C3H6,CH2O,CH3CHO,CH3OH,HCN,CH3CN,,HCOOH,TOLUENE,TPM,OC,BC,HCOOH,C2H2'
;	                       DAY,    TIME,   GENVEG,   LCT,   LATI,   LONGI,   AREA,   BMASS,   CO2,       CO,       NOX,        NO,       NO2,        SO2,       NH3,       CH4,        NMOC,
printf, 5, format = form, day[i],time[i],genveg[i],lct[i],lati[i],longi[i],area[i],bmass[i],CO2emis[i],COemis[i],NOxemis[i], NOemis[i],NO2emis[i], SO2emis[i],NH3emis[i],CH4emis[i], VOCemis[i], $
; C2H2,       C2H4,       C2H6,       C3H6,       CH2O,
	C2H2emis[i],C2H4emis[i],C2H6emis[i],C3H6emis[i],CH2Oemis[i], $
; CH3CHO,       CH3OH,       HCN,       CH3CN,       HCOOH,       TOLUENE,       TPM,       OC,       BC     
	CH3CHOemis[i],CH3OHemis[i],HCNemis[i],CH3CNemis[i],HCOOHemis[i],TOLUENEemis[i],TPMemis[i],OCemis[i],BCemis[i]
...
printf, 2, 'PM10, ', total(PM10)/1.e9
printf, 2, 'TPM, ', total(TPM)/1.e9

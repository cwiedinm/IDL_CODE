...
; 
; June 08, 2012
; - Edited to pull out Texsa region emissions for Elena's proposal
; 
;-------------------------------
;+
...
pro process_global_fireemis_daily_TEXAS
t0 = systime(1) ;Procedure start time in seconds
close, /all

for j = 0,15 do begin ; j loop is over outputs for 2002-2011. 
  if j eq 0 then begin ; 2005
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\JUNE2011\GLOB_2005_06212011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_2005_05042012.txt'
  endif
  if j eq 1 then begin ; 2006
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2010\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_2006_06082012.txt'
  endif
  if j eq 2 then begin ; JAN-APR 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_JAN-APR2007_06082012.txt'
  endif
  if j eq 3 then begin ; MAY-SEPT 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_MAY-SEPT2007_06082012.txt'
  endif
  if j eq 4 then begin ; OCT-DEC 2007
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_OCT-DEC2007_06082012.txt'
  endif
  if j eq 5 then begin ; JAN-APR 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_JAN-APR2008_06082012.txt'
  endif
  if j eq 6 then begin ; MAY-SEPT 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_MAY-SEPT2008_06082012.txt'
  endif
  if j eq 7 then begin ; OCT-DEC 2008
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_OCT-DEC2008_06082012.txt'
  endif
  if j eq 8 then begin ; JAN-NOV 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_JAN-NOV2009_06082012.txt'
  endif
  if j eq 9 then begin ; DEC 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_DEC2009_06082012.txt'
  endif
  if j eq 10 then begin ; JAN-JUN29 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_JAN-JUN2010_06082012.txt'
  endif
  if j eq 11 then begin ; JUN30-DEC 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_JUN-DEC2010_06082012.txt'
  endif
  if j eq 12 then begin ; NEW 2011 (03/2012)
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2012\GLOBAL_2011_03142012.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_2011_06082012.txt'
  endif
if j eq 13 then begin ; 2002
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2002_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_2002_06082012.txt'
  endif
  if j eq 14 then begin ; 2003
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2003_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_2003_06082012.txt'
  endif
  if j eq 15 then begin ; 2004
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2004_05122011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE2012\DAILY_TEXAS\DAILY_FIREEMIS_TEXASPM25_CO_2004_06082012.txt'
  endif
  
openw, 1, output1

printf, 1, 'Daily (clipped to Texas region) Emissions from '+infile
...
; TEXAS REGION
; LAT > 20N and LAT < 43; -118 < LONG < -92)
printf, 1, 'DAILY TOTALS FOR A REGION DEFINED BY LAT: 20-43; LONG: -118 - -92 (kg Species)'
Printf, 1, 'JD,CO2,CO,NOX,NO,NO2,NH3,SO2,VOC,NMHC,CH4,PM25,OC,BC,TPM,PM10'
for i = 0,count do begin
  today = where(jday eq i AND (lati ge 15.0 and lati le 25.0 and longi gt -113. and longi lt -86.))

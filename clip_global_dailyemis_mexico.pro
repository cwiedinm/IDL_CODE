...
;
;SEPTEMBER 03, 2013
;- Edited to clip Mexico and only certain months for zitely
;-------------------------------
;+
...
pro CLIP_global_dailyemis_MEXICO
t0 = systime(1) ;Procedure start time in seconds
close, /all



for j = 11,11 do begin ; do 2013 only 
  close, /all
  if j eq 0 then begin ; 2002
      year = 2002
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2002_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\APRIL2013\DEETER\AMAZON_dailyemis_all2002.txt'
  endif
  if j eq 1 then begin ; 2003
      year = 2003
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2003_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2003.txt'
  endif
  if j eq 2 then begin ; 2004
    year = 2004
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2004_05122011.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2004.txt'
  endif
  if j eq 3 then begin ; 2005
      year = 2005
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\JUNE2011\GLOB_2005_06212011.txt'
        output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2005.txt'
  endif
  if j eq 4 then begin ; 2006
    year = 2006
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2010\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2006.txt'
  endif
  if j eq 5 then begin ; 2007
      year = 2007
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2012\GLOBAL_2007_09172012.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2007.txt'
  endif
  if j eq 6 then begin ; 2008
      year = 2008
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2012\GLOBAL_2008_09172012.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\APRIL2013\DEETER\AMAZON_dailyemis_SEPT2008.txt'
  endif
  if j eq 7 then begin ; 2009
    year = 2009
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2012\GLOBAL_2009_09192012.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2009.txt'
  endif
  if j eq 8 then begin ; 2010
    year = 2010
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2012\GLOBAL_2010_09192012.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JANUARY2013\SouthAmerica_dailyemis_day258to271_2010.txt'
  endif
  if j eq 9 then begin ; NEW 2011 (03/2012)
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2012\GLOBAL_2011_03142012.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2011.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\NOVEMBER2012\GLOBAL_JAN-NOV2012_11082012.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2012.txt'
  endif
  if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2013\GLOBAL_JAN-JUL2013_07312013.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JULY2013\MEXICO_dailyemis_APR_JUN2013.txt'
  endif
    
openw, 1, output1
printf, 1, 'day,genveg, latitude, Longitude, area, CO, PM25, NOX, VOC'
form = '(I6,",",I6,7(",",D25.10))'
...
print, 'Min lat = ', min(lati)
print, 'Max lat = ', max(lati)
print, 'Min long = ', min(longi)
print, 'Max long = ', max(longi)
...
for i = 0,numfires-1 do begin
    if ((lati[i] gt latmin and lati[i] lt latmax) and (longi[i] lt lonmax and longi[i] gt lonmin) and (day[i] ge daymin and day[i] le daymax)) then begin 
;today = where(lati gt 0. and lati lt 12. and longi gt -95. and longi lt -45. and genveg eq 9;)
      printf, 1, format = form, day[i], genveg[i],lati[i],longi[i], area[i], CO[i], PM25[i], NOx[i], VOC[i]
    endif

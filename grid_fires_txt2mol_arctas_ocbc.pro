...
; June 29, 2009: 	Saved to new directory
; 					Edited paths for in/output files
; 					This code exports all NetCDF files except biomass
;-------------------------------
;+
...
pro grid_fires_txt2mol_arctas_OCBC
close, /all
...
; June 29, 2009
txtfile1 = 'D:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE052009\FireEmis_JAN_APR_2008_global_06052009_NEWLCT.txt'
txtfile2 = 'D:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE052009\FireEmis_MAY_SEPT_2008_global_06052009_NEWLCT.txt'
log = 'D:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE052009\Netcdf\log06292009_full.txt'
...
; New june 29, 2009
 ncfile = 'D:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE052009\NetCDF\emissions_global_JanSept2008_'+spec+'_'+resol+'.nc'
 print,ncfile
...
; Christine added this section to calculate and produce a file for OC in kg/day
  ...
  for ifire = 0L,nfires-1 do begin
   ...
   if (iday ge 0) then begin
    ...
    if (ilon eq nlon) then ilon=0
    emis_grid[ilon,ilat,iday] = emis_grid[ilon,ilat,iday] + fire_data[ifire]
   endif else printf,9,'day: ',jday[ifire],' not included. NO fires on this day (OCmass file)'
  endfor

; New june 29, 2009
 ncfile = 'D:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE052009\NetCDF\emissions_global_JanSept2008_OCmass_1x1.nc'
 print,ncfile
 ...
 fire_data = bc
  ...
  for ifire = 0L,nfires-1 do begin
   ...
   if (iday ge 0) then begin
    ...
    if (ilon eq nlon) then ilon=0
    emis_grid[ilon,ilat,iday] = emis_grid[ilon,ilat,iday] + fire_data[ifire]
   endif else printf,9,'day: ',jday[ifire],' not included. (BCmass file)'
  endfor
...
; New june 29, 2009
 ncfile = 'D:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\JUNE052009\NetCDF\emissions_global_JanSept2008_BCmass_1x1.nc'
 print,ncfile
...
for ispec = 0,nspec-1 do begin
  ...
  for ifire = 0L,nfires-1 do begin
   ...
   if (iday ge 0) then begin
    ...
    gridarea = dx * dy * 1.e4   ;cm^2
    sf = avog/gridarea/mw_co2/s_per_day ;Edited on 04/09/2009 based on Louisa's advice
    ;sf = avog/gridarea/mw/s_per_day
...
;10	urban
;0	no vegetation
if genveg[ifire] eq 6 or genveg[ifire] eq 7 or genveg[ifire] eq 8 or genveg[ifire] eq 11 or genveg[ifire] eq 12 then STOP
    ...
    endif else printf,9,'Veg Type: ',genveg[ifire],' not included. ifire =', ifire

   endif else printf,9,'day: ',jday[ifire],' not included.'

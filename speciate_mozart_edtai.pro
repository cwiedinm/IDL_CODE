...
outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\SPECIATE\FRMS2008_FCCS_08282013_MOZ4.txt'

checkfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2013\TEXAS\LOG_FRMS2008_FCCS_08283013_MOZ4.txt'
...
if smartfire eq 1 then begin
    ...
    genveg = fire.field07
	  CO2 = fire.field14
		...
		BC = fire.field28
		PM25 = fire.field25
		PM10 = fire.field30 ; Added 08/19/2010
		NOX = fire.field18
		NO = fire.field19
		NO2 = fire.field20
		NH3 = fire.field21
		...
		VOC = fire.field24
		CH4 = fire.field16
		H2 = fire.field17 ; added 09/29/2010
		area = fire.field12 ; added 03/10/2011; should be in m2
endif

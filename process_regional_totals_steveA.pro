...
pro process_regional_totals_steveA
t0 = systime(1) ;Procedure start time in seconds
close, /all

openw, 1, 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2013\PROCESS\Regional_FINNv1_totals_08052013.txt' 
Printf, 1, 'FILE,REGION,year,month,CO2,CO,CH4,NMOC,PM25,TPM,OC,BC,AREA,BIOMASS'
form = '(A30,",",A10,",",I5,",",I3,10(",",F25.10))'
...
for l = 0,11 do begin ;LOOP OVER EACH MONTH
  month = l+1 ; Set month
...
printf, 1, format = form,infile,reg,year,month,TOTCO2,TOTCO,TOTCH4,TOTNMOC,TOTPM25,TOTTPM,TOTOC,TOTBC,TOTAREA,TOTBMASS

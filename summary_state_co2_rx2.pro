...
; DECEMBER 10, 2008: edited to do the RX1 output files


pro summary_state_CO2_RX2
...
; 2002
if year1 eq 2002 then infile = path + 'Modelout_test_2002_12102008_RX2.txt'
; 2003
if year1 eq 2003 then infile = path + 'Modelout_test_2003_12102008_RX2.txt'
; 2004
if year1 eq 2004 then infile = path + 'Modelout_test_2004_12102008_RX2.txt'
; 2005
if year1 eq 2005 then infile = path + 'Modelout_test_2005_12102008_RX2.txt'
; 2006
if year1 eq 2006 then infile = path + 'Modelout_test_2006_12102008_RX2.txt'
;2007
if year1 eq 2007 then infile = path + 'Modelout_test_2007_12102008_RX2.txt'

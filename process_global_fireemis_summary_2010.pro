...
pro process_global_fireemis_summary_2010
t0 = systime(1) ;Procedure start time in seconds
close, /all

openw, 1, 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\MARCH2011\PROCESS\REGIONAL_SUMMARIES_2010only.txt' 
...
for j = 10,11 do begin ; j loop is over all of the files. 

...
pro clip_finnv15_CO2_AndyJacobson_totals
...
for j = 13,13 do begin ; do 2011-2014
print, 'J = ', j
  ...
  if j eq 0 then begin ; 2002
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2002_06082015_Totals.txt'
  endif
  if j eq 1 then begin ; 2003
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2003_06242014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2003_06082015_Totals.txt'
  endif
  if j eq 2 then begin ; 2004
    year = 2004
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2004_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2004_06082015_Totals.txt'
  endif
  if j eq 3 then begin ; 2005
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2005_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2005_06082015_Totals.txt'
  endif
  if j eq 4 then begin ; 2006
    year = 2006
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2006_06262014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2006_06082015_Totals.txt'
  endif
  if j eq 5 then begin ; 2007
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2007_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2007_06082015_Totals.txt'
  endif
  if j eq 6 then begin ; 2008
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2008_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2008_06082015_Totals.txt'
  endif
  if j eq 7 then begin ; 2009
    year = 2009
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2009_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2009_06082015_Totals.txt'
  endif
  if j eq 8 then begin ; 2010
    year = 2010
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2010_06262014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2010_06082015_Totals.txt'
  endif
 if j eq 9 then begin ; NEW 2011
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2011_06082015_Totals.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2_2012_06082015_Totals.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2__2013_06082015_Totals.txt'
  endif
    ...
    year = 2014
       ...
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\CO2_AndyJacobson\FINNv15_CO2__2014_06082015_Totals.txt'
  endif
  if j eq 13 then begin ; 2015
    year = 2015
    infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\JAN2016\FINNv1.5_2015_01222016.txt'
    output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\APRIL2016\ANDYJ\FINNv15_CO2_2015_04212016_Totals.txt'
  endif
    
openw, 1, output1
printf, 1, 'day,genveg, latitude, longitude,CO2'
form = '(I6,",",I6,3(",",D25.10))'
...
for i = 0,numfires-1 do begin
   if (lati[i] lt latmax and lati[i] gt latmin and longi[i] gt lonmin and longi[i] lt lonmax and day[i] ge daymin and day[i] le daymax and genveg[i] gt 0) then begin
      printf, 1, format = form, day[i],genveg[i], lati[i], longi[i], co2[i]
  endif
endfor

;Hgtotal = total(Hg)
;bbtotal = total(bburned)
;COtotal = total(co)
;OCtotal = total(OC)
;
;print, 'YEAR = ', year
;print, 'HG Total (g) = ', Hgtotal
;print, 'CO Total (kg) = ', COtotal
;print, 'OC total (kg) = ', OCtotal
;print, 'BB Total (kg) = ', bbtotal
;
;CA = where(lati ge 0 and lati le 24 and longi le -48 and longi ge -108)
;HgtotalCA = total(Hg[CA])
;bbtotalCA = total(bburned[CA])
;COtotalCA = total(co[CA])
;OCtotalCA = total(OC[CA])
;
;print, 'YEAR = ', year
;print, 'CA HG Total (g) = ', HgtotalCA
;print, 'CA CO Total (kg) = ', COtotalCA
;print, 'CA OC total (kg) = ', OCtotalCA
;
;NSA = where(lati ge -24 and lati le 0 and longi le -32 and longi ge -90)
;HgtotalNSA = total(Hg[NSA])
;bbtotalNSA = total(bburned[NSA])
;COtotalNSA = total(co[NSA])
;OCtotalNSA = total(OC[NSA])
;
;print, 'YEAR = ', year
;print, 'NSA HG Total (g) = ', HgtotalNSA
;print, 'NSA CO Total (kg) = ', COtotalNSA
;print, 'NSA OC total (kg) = ', OCtotalNSA
;
;SSA = where(lati ge -60 and lati le -24 and longi le -40 and longi ge -80)
;HgtotalSSA = total(Hg[SSA])
;bbtotalSSA = total(bburned[SSA])
;COtotalSSA = total(co[SSA])
;OCtotalSSA = total(OC[SSA])
;
;print, 'YEAR = ', year
;print, 'SSA HG Total (g) = ', HgtotalSSA
;print, 'SSA CO Total (kg) = ', COtotalSSA
;print, 'SSA OC total (kg) = ', OCtotalSSA

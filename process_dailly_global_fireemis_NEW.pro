...
pro process_global_TOTALS_fireemis_JM
t0 = systime(1) ;Procedure start time in seconds
close, /all

output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OCTOBER2012\global_crop_totals.txt'
openw, 1, output1
...
printf, 1, 'year, CO2, CO, SO2, NOX, NO, NO2, PM25, PM10, BC, OC, CH4'
form = '(I5,11(",",D25.10))'
...
; OUTPUT ONLY Croplands
  if (genveg[i] ne 9) then goto, skip1
  CO2tot = 0.0+CO2[i]
  COtot = 0.0+CO[i]
  NOxtot = 0.0 +nox[i]
  NOtot = 0.0+no[i]
...
; ' CO2, CO, SO2, NOX, NO, NO2, PM25, PM10, BC, OC, CH4'
 printf, 1, format = form, year, CO2tot, COtot, SO2tot, NOXtot, NOtot, NO2tot, PM25tot, PM10tot, BCtot, OCtot, CH4tot

...
pro clip_finnv15_CO_Ricardo_Navrongo
...
for j = 10,13 do begin ; do 2011-2014
print, 'J = ', j
  ...
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\MAY2016\RICARDO\FINNv15_CO_2012_KN_05202016_Totals.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\MAY2016\RICARDO\FINNv15_CO_2013_KN_05202016_Totals.txt'
  endif
    ...
    year = 2014
       ...
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\MAY2016\RICARDO\FINNv15_CO_2014_KN_05202016_Totals.txt'
  endif
  if j eq 13 then begin ; 2015
    year = 2015
    infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\JAN2016\FINNv1.5_2015_01222016.txt'
    output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\MAY2016\RICARDO\FINNv15_CO_2015_KN_05202016_Totals.txt'
  endif
...
for i = 1,daymax do begin
   COtot = 0.0
   daynow = where(lati lt latmax and lati gt latmin and longi gt lonmin and longi lt lonmax and day eq i) 
   if daynow[0] lt 1 then COtot = 0.0 else COtot = total(CO[daynow])
   printf, 1, format = form, i,COtot
endfor

...
pro CLIP_global_dailyemis_totals_allyears
...
today = where(jday eq i AND (lati[i] gt latmin and lati[i] lt latmax and longi[i] lt lonmax and longi[i] gt lonmin))
...
printf, 1, format = form, i, COin, PM25in, NOxin, VOCin
  skip1:
endfor

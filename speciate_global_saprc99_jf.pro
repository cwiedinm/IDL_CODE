...
; 
; OCTOBER 15, 2014
; - renamed speciate_global_SAPRC99_stacy to speciate_global_SAPRC99_CL for Chris Loughner
; - edited for 2013
; -
; FEBRUARY 20, 2015
; - renamed it speciate_global_SAPRC99_CL to speciate_global_SAPRC99_JF
; - Ran this with the full 2014 emissions file for Jerome Fast
; 
; DECEMBER 01, 2015
; - set up to run with new 2014 and 2015 files created today
; 
; MARCH 15, 2016
; - Edited to run with full year of 2015 emissions (that were created in Jan. 2016)
; 
; 
; NOVEMBER 03, 2016
; - Edited to run the 2016 global fire emissions created on 11022016
; - Edited to run with the 2015 global file created in September
; 
; APRIL 03, 2017
; - Edited to process the new 2014 file created today
; 
;  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$

pro speciate_global_SAPRC99_JF
close, /all
...
outfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2017\APRIL2017\SPECIATED\GLOBAL_FINNv15_2014_SAPRC99_04032017.txt'
checkfile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2016\NOVEMBER2016\SPECIATE\LOG_GLOBAL_FINNv15_2014_SAPRC99_04032017.txt.txt'
...
; OCtober 15, 2015 - Added BB to the output
...
printf, 5, 'DAY,TIME,GENVEG,LATI,LONGI,AREA,BB,CO2,CO,NO,NO2,SO2,NH3,CH4,VOC,ACET,ALK1,ALK2,ALK3,ALK4,ALK5,ARO1,ARO2,BALD,CCHO,CCO_OH,ETHENE,HCHO,HCN,HCOOH,HONO,ISOPRENE,MEK,MEOH,METHACRO,MGLY,MVK,OLE1,OLE2,PHEN,PROD2,RCHO,RNO3,TRP1,OC,BC,PM25,PM10'
form='(I6,",",I6,",",I6,45(",",D20.10))'
...
; OCTOBER 15, 2014: Ran for Chris Loughner (CL) 
; Lat: 10 -> 65 degrees
; Lon: -145 -> -45 degrees
;latmin = 10.
;latmax = 65.
...
;    6 = temperate evergreen forest (added 07/16/2014)
;    
...
; Speciate VOC emissions. VOC is in kg and the output of this is mole SAPRC99 Emissions species
...
;                         DAY,   TIME,   GENVEG,   LATI,   LONGI,   area,   BB,        CO2,       CO,       NO,       NO2,        SO2,       NH3,       CH4,       VOC, 
printf, 5, format = form, day[i],time[i],genveg[i],lati[i],longi[i],area[i],BMASSBURN, CO2emis[i],COemis[i],NOemis[i],NO2emis[i], SO2emis[i],NH3emis[i],CH4emis[i], VOCemis[i],$

...
;   
; OCTOBER 28, 2013
; - Saved as global_fire_TEXAS2
; *********************************************************************************************

pro global_fire_TEXAS2
...
close, /all
 ...
 confmin = 20 ; SET MINIMUM CONFIDENCE LEVEL
...
;   READ IN EMISSION FACTOR FILE
   ...
   ;  emisin = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_INPUTS\NEW_EFS_10282013.csv'
    ; emisin = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_INPUTS\NEW_EFS_LOWER_10282013.csv'
     emisin = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_INPUTS\NEW_EFS_UPPER_10282013.csv'
...
; OUTPUT FILE
; ****************************************************************************
     outfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\OCT2008\FINNv1_TX_NEWEMIS1_HIGH_10282013.txt'
     openw, 6, outfile
    ...
    logfile = 'E:\Data2\wildfire\TEXAS\FIRE_2008\MODEL_OUTPUT\OCT2008\_LOG_FINNv1_TX_NEWEMIS1_HIGH_10282013.txt'
       openw, 9, logfile
...
; COMMENTED OUT THIS CODE- THIS IS THE NEW ONE 
;    if lct[j] eq 1 or lct[j] eq 3 then begin  ; Needleleaf forests
...
;       goto, endveg                                      ; Assign Boreal for Lat > 50; Temperate for all else
;                                                         ; ADDED GENVEG 7 in JUNE 2013... to go with new EMISSION FACTORS
;    endif
;    if lct[j] eq 5 then begin ; Mixed Forest, Assign Fuel Load by Latitude
;       if lat[j] gt 50 then begin  ; 10/19/2009: Changed the latitude border to 50degrees N (from 60 before) and none in S. Hemisphere
;         genveg = 5
...
; 
; JUNE 25, 2013: Changed the emission factors for evergreen temperate

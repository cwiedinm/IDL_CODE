...
; 
; JUNE 03, 2015
; - edited to clup out only North america and central america CO and PM2.5 emissions for ECMB and YO project
; 
;-------------------------------
;+
...
print, 'J = ', j
  ...
  if j eq 0 then begin ; 2002
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2002_06032015.txt'
  endif
  if j eq 1 then begin ; 2003
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2003_06242014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2003_06032015.txt'
  endif
  if j eq 2 then begin ; 2004
    year = 2004
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2004_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2004_06032015.txt'
  endif
  if j eq 3 then begin ; 2005
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2005_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2005_06032015.txt'
  endif
  if j eq 4 then begin ; 2006
    year = 2006
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2006_06262014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2006_06032015.txt'
  endif
  if j eq 5 then begin ; 2007
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2007_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2007_06032015.txt'
  endif
  if j eq 6 then begin ; 2008
     ...
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2008_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2008_06032015.txt'
  endif
  if j eq 7 then begin ; 2009
    year = 2009
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2009_06252014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2009_06032015.txt'
  endif
  if j eq 8 then begin ; 2010
    year = 2010
     infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2010_06262014.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2010_06032015.txt'
  endif
 if j eq 9 then begin ; NEW 2011
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2011_06032015.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2012_06032015.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2013_06032015.txt'
  endif
    ...
    year = 2014
       ...
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JUN_2015\NACA\FINNv15_2014_06032015.txt'
  endif
  
    
openw, 1, output1
printf, 1, 'day,genveg, latitude, longitude,CO,PM2.5'
form = '(I6,",",I6,4(",",D25.10))'
...
; 6/03/2015 edited for North and Central America (NACA) 
latmin = 10.0
latmax = 53.0
lonmin = -130.
lonmax = -55.
...
for i = 0,numfires-1 do begin
  if (lati[i] lt latmax and lati[i] gt latmin and longi[i] gt lonmin and longi[i] lt lonmax and day[i] ge daymin and day[i] le daymax and genveg[i] gt 0) then begin
      printf, 1, format = form, day[i],genveg[i], lati[i], longi[i], co[i], pm25[i]
  endif
endfor

...
for j = 0,11 do begin ; j loop is over all of the files. 
  ...
  if j eq 0 then begin ; 2005
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_2005_08242010_PROCESS_BEIJING.txt'
endif
  if j eq 1 then begin ; 2006
      infile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\AUGUST2010\GLOB_2006_09032010.txt'
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_2006_09032010_PROCESS_BEIJING.txt'
  endif
  if j eq 2 then begin ; JAN-APR 2007
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_JAN-APR2007_09072010_PROCESS_BEIJING.txt'
  endif
  if j eq 3 then begin ; MAY-SEPT 2007
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_MAY-SEPT2007_09072010_PROCESS_BEIJING.txt'
  endif
  if j eq 4 then begin ; OCT-DEC 2007
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_OCT-DEC2007_09072010_PROCESS_BEIJING.txt'     
  endif
  if j eq 5 then begin ; JAN-APR 2008
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_JAN-APR2008_09082010_PROCESS_BEIJING.txt'
  endif
  if j eq 6 then begin ; MAY-SEPT 2008
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_MAY-SEPT2008_09082010_PROCESS_BEIJING.txt'
  endif
  if j eq 7 then begin ; OCT-DEC 2008
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_OCT-DEC2008_09082010_PROCESS_BEIJING.txt'
  endif
  if j eq 8 then begin ; JAN-NOV 2009
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_JAN-NOV2009_09082010_PROCESS_BEIJING.txt'
  endif
  if j eq 9 then begin ; DEC 2009
      infile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\GLOB_DEC2009_09092010.txt'
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_DEC2009_09092010_PROCESS_BEIJING.txt'
  endif
  if j eq 10 then begin ; JAN-APR 2010
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_JAN-APR2010_09092010_PROCESS_BEIJING.txt'
  endif
  if j eq 11 then begin ; MAY-AUG27 2010
      ...
      output1 = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2010\PROCESS\DAILY_FIREEMIS_GLOB_MAY-AUG27_2010_09092010_PROCESS_BEIJING.txt'      
  endif
  
  
openw, 1, output1

printf, 1, 'Daily BEIJING (HELEN extent) Emissions from '+infile
...
; Beijing Daily Totals   
; 32°-45°N, 108°-124°E?
printf, 1, 'BEIJING TOTALS (kg Species)'
Printf, 1, 'JD,CO2,CO,NOX,NO,NO2,NH3,SO2,VOC,NMHC,CH4,PM25,OC,BC,TPM,PM10'
for i = 0,count do begin
  today = where(jday eq i AND (lati gt 32. and lati lt 45. and longi gt 108. and longi lt 124.))

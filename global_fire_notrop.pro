...
;  -this version doesn't double the tropical forests
; *********************************************************************************************

pro global_fire_notrop
...
; LCT GenVegType  GenVegType  MCE CO2 CO  CH4 NMOC  H2  NOx SO2 PM2.5 TPM TPC OC  BC  NH3 NO  NO2 NMHC
       lctemis = emis.field01   ; LCT Type (Added 10/20/2009)
       vegemis = emis.field02   ; generic vegetation type --> this is ignored in model
       CO2EF = emis.field05     ; CO2 emission factor
       COEF = emis.field06      ; CO emission factor
       CH4EF = emis.field07     ; CH4 emission factor
       NMHCEF = emis.field20    ; NMHC emission factor
       NMOCEF = emis.field08    ; NMOC emission factor (added 10/20/2009)
       H2EF = emis.field09      ; H2 emission factor
       NOXEF = emis.field10     ; NOx emission factor
       NOEF = emis.field18      ; NO emission factors (added 10/20/2009)
       NO2EF = emis.field19     ; NO2 emission factors (added 10/20/2009)
       SO2EF = emis.field11     ; SO2 emission factor
       PM25EF = emis.field12    ; PM2.5 emission factor
       TPMEF = emis.field13     ; TPM emission factor
       TCEF = emis.field14      ; TC emission factor
       OCEF = emis.field15      ; OC emission factor
       BCEF = emis.field16      ; BC emission factor
       NH3EF = emis.field17     ; NH3 emission factor
...
; outfile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DEC2009\GLOB_OCT_DEC2007_12092009.txt' ; RAN DEC. 09, 2009
 outfile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DEC2009\GLOB_JAN-APR2008_12092009_NOTROP.txt' ; RAN DEC. 09, 2009
     openw, 6, outfile
     print, 'opened output file: ', outfile
     printf, 6, 'longi,lat,day,TIME,lct,genLC,globreg,pct_tree,pct_herb,pct_bare,area,bmass,CO2,CO,CH4,H2,NOx,NO,NO2,NH3,SO2,NMHC,NMOC,PM25,TPM,OC,BC,TPC,FACTOR'
     form = '(D20.10,",",D20.10,",",(8(I10,",")),2(D20.10,","),16(D25.10,","),F6.3)'

    ; Print an output log file
    logfile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DEC2009\LOG\GLOB_JAN-APR2008_LOG_12092009_NOTROP.txt'
       openw, 9, logfile
...
;     inpath='D:\Data2\wildfire\AMAZE\MODIS_RR\global_april_aug2008\global_model\'
 ...
 infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2008\NEWLCT\LCT_TREE_HERB_BARE_GLOBREG_LCT2.txt' ; RAN DEC. 09, 2009 (Jan-April 2008)
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2007\GLOB_OCT_DEC2007_10212009.txt' ; RAN DEC. 09, 2009
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2007\GLOB_MAY_SEP2007_10212009.txt' ; RAN DEC. 08, 2009
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2007\GLOB_JAN_APR2007_10212009.txt' ; RAN DEC. 08, 2009
;  infile = 'F:\Data2\wildfire\MODEL_INPUTS\AUSTRAILIA\AUS2003_input_12082009.txt' ; Ran DEC. 08, 2009
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\AUSTRAILIA\AUSNZ_JAN-MAR2003.txt' ; RAN DEC. 07, 2009
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\TEST_INPUT.txt' ; Test input file created on NOV. 25, 2009
 
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2009\GLOB_JUL_SEPT2009_10212009.txt' ; RAN OCT. 22, 2009 (Jul-Sept, 2009)
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2009\GLOB_MAY_JUL082009_10212009.txt' ; RAN OCT. 21, 2009 (MAY-JUL, 2009)
; infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2009\GLOB_JAN_APR2009_10212009.txt' ; RAN OCT. 21, 2009 (JAN-APR, 2009) - reran 11/18/2009; Reran NOV. 20, 2009; reran 11/25/2009
    
;infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2008\NEWLCT\ GLOB_OCT_DEC2008_10212009.txt' ; RAN OCT. 21, 2009 (Oct-DEC, 2008)   
;infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2008\NEWLCT\LCT_TREE_HERB_BARE_GLOBREG2_LCT2.txt' ; RAN OCT. 21, 2009 (May-Sept, 2008)
;infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2008\NEWLCT\LCT_TREE_HERB_BARE_GLOBREG_LCT2.txt' ; RAN OCT 21, 2009 (Jan-Apr, 2008)
;infile = 'F:\Data2\wildfire\MODEL_INPUTS\GLOBAL\2007\GLOB_OCT_DEC2007_10212009.txt' ; RAN OCT. 21, 2009 (Ran all three 2007 files on this day)

; infile = 'F:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\TESTOCT2009\TEst_INPUT_4points.csv' ; Ran on 10/20/2009 to check 4 point by calculations
; infile = 'F:\Data2\wildfire\EPA_EI\MODEL\IDL_CODE\TEST2009\test_global_input2.csv' ; Ran Test case on 10/16/2009 and on 10/19/2009
; infile = 'F:\Data2\wildfire\ALMA\NEW_092009\GIS\EUROPE2003_LCT_TREE_HERB_BARE_REG.csv' ; Ran on SEPT. 29, 2009 (Alma's new 2003 European Fires)
...
; Sept. 29, 2009: date format = '2003-06-29'
; ; DEC. 07, 2009: Date format = '2003-01-12' (2008-01-30)
for i = 0L,numfire1-1 do begin
...
; Identify Tropics: 
 ...
 newfires = numfire1 ; add the additional fires to the 
...
;if jd[j] ge 181 then goto, skipfire ; ONLY FOR May-July08, 2009 FILE
...
;     where the tropics are doubled. 
       CO2 = CO2EF[index]*area*bmass*(factortrop[j])
...
printf,6,format = form, lon[j],lat[j],jd[j],time[j],lct[j],genveg,globreg[j],tree[j],herb[j], $
       bare[j],area,bmass,CO2,CO,CH4,H2,NOX,NO,NO2,NH3,SO2,NMHC,NMOC,PM25,TPM,OC,BC,TPC, Factortrop[j]

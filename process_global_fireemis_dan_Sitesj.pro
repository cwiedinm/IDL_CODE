...
if j eq 0 then begin ; 2002
      infile = path+'DAILY_FIREEMIS_GLOB_2002_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2002_GOTH.txt'
endif
if j eq 1 then begin ; 2003
      infile = path+'DAILY_FIREEMIS_GLOB_2003_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2003_GOTH.txt'
endif
if j eq 2 then begin ; 2004
      infile = path+'DAILY_FIREEMIS_GLOB_2004_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2004_GOTH.txt'
endif
if j eq 3 then begin ; 2005
      infile = path+'DAILY_FIREEMIS_GLOB_2005_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2005_GOTH.txt'
endif
if j eq 4 then begin ; 2006
      infile = path+'DAILY_FIREEMIS_GLOB_2006_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2006_GOTH.txt'
endif
if j eq 5 then begin ; 2007
      infile = path+'DAILY_FIREEMIS_GLOB_2007_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2007_GOTH.txt'
endif
if j eq 6 then begin ; 2008
      infile = path+'DAILY_FIREEMIS_GLOB_2008_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2008_GOTH.txt'
endif
if j eq 7 then begin ; 2009
      infile = path+'DAILY_FIREEMIS_GLOB_2009_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2009_GOTH.txt'
endif
if j eq 8 then begin ; 2010
      infile = path+'DAILY_FIREEMIS_GLOB_2010_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2010_GOTH.txt'
endif
if j eq 9 then begin ; 2011
      infile = path+'DAILY_FIREEMIS_GLOB_2011_DANJ_11212011.txt'
      output1 = path+'IMPROVE_2011_GOTH.txt'
endif

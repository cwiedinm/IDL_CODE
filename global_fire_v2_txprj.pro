...
pro global_fire_v2_TXprj, scen=scen, infile=infile, simid=simid
...
; ##########################################################################
if not keyword_set(simid) then simid='mod2012_subdivided'

; yk: incrementing version number
;todaydate = '_11192014B' ; this is for naming the output file
todaydate = '_06032015' ; this is for naming the output file
...
;outfile = filepath('../MODEL_OUTPUTS/' + simid + '_'+scename+todaydate+'.txt', root_dir=rootdir)
     ...
     printf, 6, 'longi,lat,polyid,fireid,day,glc,lct,fccs,fccs_cdl,tceq,tceq_cdl,genLC,pcttree,pctherb,pctbare,area,bmass,CO,NOx,NH3,SO2,NMOC,PM25,PM10,OC,BC,' + $
	     ',month,scen,scenuse,lctorig,glcorig,tceqorig,tceqcdlorig, state'
...
;;     form = '(D20.10,",",D20.10,",",(8(I10,",")),14(D25.10,","),2(",",i2))'
     form = '(e14.6,",",e14.6,",",(10(I9,",")),14(e14.6,","),7(",",i5),",",A4)' ; 03/11/2015: removed STATE and TIME from output header and format
...
;DATE,POLYID,FIREID,FIRELAT,FIRELON,AREA,TREE,HERB,BARE,LCT,GLC,ESA,FCCS,FCCSCDL,TCEQ,TCEQCDL,STATE,pct_LCT,pct_GLC,pct_ESA,pct_FCCS,pct_FCCSCDL,pct_TCEQ,pct_TCEQCDL,pct_STATE
        ...
        lct1 = map.field10 
        esa1 = map.field12 ; CW added March 05, 2015 
        glc1 = map.field11 ; 
        fccs1 = map.field13

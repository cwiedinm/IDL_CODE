...
pro CLIP_global_dailyemis_SouthAmerica_deeter
t0 = systime(1) ;Procedure start time in seconds
close, /all



for j = 6,6 do begin ; do 2008 only 
  close, /all
...
for i = 0,numfires-1 do begin
    if (lati[i] gt latmin and lati[i] lt latmax and longi[i] lt lonmax and longi[i] gt lonmin and day[i] ge 245 and day[i] le daymax) then begin 

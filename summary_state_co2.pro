...
; 2002
if year1 eq 2002 then infile = path + 'Modelout_test_2002_12082008.txt'
; 2003
if year1 eq 2003 then infile = path + 'Modelout_test_2003_12082008.txt'
; 2004
if year1 eq 2004 then infile = path + 'Modelout_test_2004_12082008.txt'
; 2005
if year1 eq 2005 then infile = path + 'Modelout_test_2005_12082008.txt'
; 2006
if year1 eq 2006 then infile = path + 'Modelout_test_2006_12082008.txt'
;2007
if year1 eq 2007 then infile = path + 'Modelout_test_2007_12082008.txt'
...
outfile = pathout +'Emis_state_CO2_summ_USonly'+year+ext+'.txt'

outfile2 = pathout +'Emis_state_CO_summ_USonly'+year+ext+'.txt'

outfile3 = pathout +'Emis_state_PM25_summ_USonly'+year+ext+'.txt'

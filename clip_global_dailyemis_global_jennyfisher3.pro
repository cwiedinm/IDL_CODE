...
pro CLIP_global_dailyemis_global_JennyFisher3
...
for j = 0,0 do begin ; do 2014 file that was created in november 2014
  close, /all
  ...
  if j eq 9 then begin ; NEW 2011
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2011_01282015.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2012_01282015.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2013_01282015.txt'
  endif
     if j eq 12 then begin ; 2014
    year = 2014
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15a_2014thru0831_11252014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\Fisher_Input_2014thru0831_01282015.xt'
  endif
...
for i = 0,numfires-1 do begin ; Sum all emissions over each day 
    if day[i] gt daymax then goto, skipthisone
    CO2mole = CO2[i]/44.01*1000. ; convert to moles CO2
    printf, 1, format = form,day[i],genveg[i],lati[i],longi[i],co2mole
    skipthisone:
endfor

...
pro CLIP_global_dailyemis_Colorado_allyears
t0 = systime(1) ;Procedure start time in seconds
close, /all



for j = 10,10 do begin ; do 2002-2012
  close, /all
  if j eq 0 then begin ; 2002
      year = 2002
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2011\MAY2011\GLOB_2002_05102011.txt'
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2002.txt'
  endif
  ...
  if j eq 6 then begin ; 2008
      ...
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\SEPTEMBER2012\GLOBAL_2008_09172012.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2008.txt'
  endif
  ...
  if j eq 8 then begin ; 2010
    year = 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\DECEMBER2012\COLORADO\COLORADO_dailyemis_all2010.txt'
  endif
...
openw, 1, output1
printf, 1, 'day, latitude, Longitude,CO, PM25, NOX, VOC'
form = '(I6,6(",",D25.10))'
...
;today = where(lati gt 0. and lati lt 12. and longi gt -95. and longi lt -45. and genveg eq 9;)
      printf, 1, format = form, day[i], lati[i],longi[i], CO[i], PM25[i], NOx[i], VOC[i]
    endif
skip1:
endfor

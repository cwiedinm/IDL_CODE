...
pro process_TEXAS_FIRE_EMISS_SCENARIOS_CANMEX
t0 = systime(1) ;Procedure start time in seconds
close, /all

year = 2008

for j = 0,10 do begin ; do same processing for every file
  close, /all
...
for i = 0,11 do begin
        month = i+1
         ...
         ; Get totals by state/province
         statename = strarr(24)
         statename = ['Newfoundland','Nova Scotia','Quebec','Manitoba','Alberta','Saskatchewan','Ontario','British Columbia','New Brunswick','Baja California','Chihuahua','Coahuila','Nuevo Leon','Tamaulipas','Sinaloa','Durango','Sonora','Zacatecas','San Luis Potosi','Jalisco','Aguascalientes','Veracruz','Nayarit','Baja California Sur']

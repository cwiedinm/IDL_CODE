...
;
;JUNE 01, 2014
;- edited to output the files for Jenny. Ran for 2012 and 2013 today
;
;DECEMBER 17, 2014
;- Renamed clip_global_dailyemis_global_jennyfisher3.pro
;- Ran through 2014 file (created in 11/26/2014) for Jenny, Jun Zhu etc. 
;
;JANUARY 28, 2015
;- Edited to process all years to produce files for Jenny, Jun Zhu
;- Swtiched out the input/output files
;- Made it so that only 365 days are included in each file (except for Leap Years -- then 366 days)
;
;
;APRIL 20, 2015
;- renamed this file from CLIP_global_dailyemis_global_JennyFisher3.pro -->  global_dailyemis_global_TomOda_1degree.pro
;- set to process 2011 - 2014 only
;- updated 2014 file to be processed
;- put output in directory for APR2015
;- 
;
;-------------------------------
;+
...
pro global_dailyemis_global_TomOda_1degree
...
for j = 9,9 do begin ; 04/20/2015: Edited to only process 2011-2014
  close, /all
  if j eq 0 then begin ; 2002
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2002_01282015.txt'
  endif
  if j eq 1 then begin ; 2003
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2003_01282015.txt'
  endif
  if j eq 2 then begin ; 2004
    year = 2004
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2004_06252014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2004_01282015.txt'
  endif
  if j eq 3 then begin ; 2005
      ...
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2005_06252014.txt'
        output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2005_01282015.txt'
  endif
  if j eq 4 then begin ; 2006
    year = 2006
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2006_01282015.txt'
  endif
  if j eq 5 then begin ; 2007
      ...
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2007_06252014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2007_01282015.txt'
  endif
  if j eq 6 then begin ; 2008
      ...
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2008_06252014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2008_01282015.txt'
  endif
  if j eq 7 then begin ; 2009
    year = 2009
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2009_01282015.txt'
  endif
  if j eq 8 then begin ; 2010
    year = 2010
      ...
      output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\JAN_2015\JENNY\FINNV1.5_JFversion_2010_01282015.txt'
  endif
  if j eq 9 then begin ; NEW 2011
    year = 2011
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2011_06272014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2011_0.1grid_TomO_04212015.txt'
  endif
  if j eq 10 then begin ; 2012
    year = 2012
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2012_06282014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2012_0.1grid_TomO_04212015.txt'
  endif
   if j eq 11 then begin ; 2013
    year = 2013
      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_FINNv15_2013_06202014.txt'
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2013_0.1grid_TomO_04212015.txt'
  endif
    ...
    year = 2014
       ...
       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS_2015\APR_2015\Tom_ODA\FINNV1.5_2014_0.1grid_TomO_04212015.xt'
  endif
;    if j eq 13 then begin ; 2014
;    year = 2014
;      infile = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\JUNE2014\GLOBAL_JAN-NOV2013_1210013.txt'
;       output1 = 'E:\Data2\wildfire\MODEL_OUTPUTS\GLOBAL\OUTPUTS2014\DEC2014\JENNY\Fisher_Input_2013_06012014.xt'
;  endif 
    
; Output day,genveg, latitude, Longitude, CO2
; CO2 is in moles.... not MASS

openw, 1, output1
printf, 1, 'day,latitude, longitude,CO, PM2.5'
form = '(I6,",",4(",",D25.10))'
...
nlat = (latmax - latmin)*10.
nlon = (lonmax - lonmin)*10.

for i = 1, daymax do begin ; Loop over each day
  for k = 0,nlat-1 do begin
  for m = 0,nlon-1 do begin
      lonnow = lonmin + (m*0.1)
      latnow = latmin + (k*0.1)
      COnow = where(lati ge (latnow-0.05) and lati lt (latnow + 0.05) and longi ge (lonnow-0.05) and longi lt (lonnow + 0.05) and day eq i)
      if COnow le 0 then goto, skipgrid 
      COtotal = total(CO[COnow])
      PMtotal = total(PM25[COnow])
      printf, 1, day, latnow, lonnow, COtotal, PMtotal
      skipgrid:
   endfor ; end m loop
   endfor ; end k loop
endfor ; end i loop (over each day)
